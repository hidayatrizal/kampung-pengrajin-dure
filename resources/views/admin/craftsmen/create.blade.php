...
@section('title', 'Tambah Toko/UMKM')
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-2xl border border-stone-100 p-6 md:p-10">
        <h2 class="font-serif text-2xl text-stone-900 mb-8">Tambah Toko/UMKM Baru</h2>

        <form method="POST" action="{{ route('admin.craftsmen.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="capacity" id="capacity" value="{{ old('capacity') }}" min="0" placeholder="Contoh: 500"
                ...
                <div>
                    ...
                    <input type="text" name="price" id="price" value="{{ old('price') }}" placeholder="Contoh: Rp 50.000 - Rp 500.000"
                ...
                <div class="md:col-span-2">
                    <label for="image" class="text-[11px] uppercase tracking-[0.2em] text-stone-500 font-semibold block mb-2">Foto Pemilik/Pengrajin</label>
                    <div class="relative">
                        <input type="file" name="image" id="image" accept="image/jpeg,image/png,image/webp" required
                            class="hidden" onchange="previewImage(this, 'preview-craftsman')">
                        <label for="image" id="preview-craftsman" class="block border-2 border-dashed border-stone-200 rounded-xl p-8 text-center cursor-pointer hover:border-terracotta-400 hover:bg-terracotta-50/30 transition-all">
                            ...
                            <p class="text-sm text-stone-400">Klik untuk memilih foto</p>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="address" id="address" rows="2"
                        class="w-full bg-stone-50 border border-stone-200 rounded-xl px-4 py-3.5 text-sm text-stone-900 placeholder:text-stone-400 outline-none focus:border-terracotta-500 focus:ring-2 focus:ring-terracotta-500/10 transition-all @error('address') border-red-400 @enderror">{{ old('address') }}</textarea>
                ...
                <div>
                    ...
                    <input type="text" name="latitude" id="latitude" value="{{ old('latitude') }}" placeholder="Contoh: -7.1234567"
                ...
                <div>
                    ...
                    <input type="text" name="longitude" id="longitude" value="{{ old('longitude') }}" placeholder="Contoh: 110.1234567"
